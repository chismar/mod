...
NDiplomacy = {
	...
	MIN_WARGOAL_JUSTIFY_COST = 1.8,					-- It always takes atleast 10 days to justify a wargoal
	...
	TENSION_TIME_SCALE_START_DATE = "2277.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	GUARANTEE_COST = 35,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 35,
...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 1,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
...
NAI = {
	...
	TENSION_MIN_FOR_GUARANTEE_VS_MINOR = 20, -- for non faction people AI will not consider you worth guaranteeing below this
